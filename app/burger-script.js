...
function createBurger(activateWidth) {
    if (activateWidth.matches) {
        ...
        burger.addEventListener('click', function(){
            ...
            document.getElementById("anchor").addEventListener('click', deleteBurgerOnClick);
        });
    }
}    
...
function deleteBurgerOnClick() {
        document.getElementById("burger").remove();
        document.getElementById("close").remove();
        document.getElementById("menu").remove();
        document.getElementById("anchor").removeEventListener('click', deleteBurgerOnClick);
        createBurger(activateWidth);
}
